...
// 暴力法求最近点对距离
double bruteForceClosestPair2D(const std::vector<Point> &points) {
...
double closestPair2D(std::vector<Point> &points) {
...
int main() {
  ...
  double bruteResult = bruteForceClosestPair2D(points);
  ...
  double divideResult = closestPair2D(points);
